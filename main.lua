-- created on 5/06/21
-- developed by dollershiphing (pain exists please help)
...
local window = library:CreateWindow('Funky Friday') do
	...
	local folder = window:AddFolder('Credits') do
		...
		folder:AddLabel({ text = 'DOLLERSHIPHING - Everything' })
		folder:AddLabel({ text = '74j - for being advisor' })
        folder:AddLabel({ text = 'Mekbok - Being a real nigga' })
	end
end
